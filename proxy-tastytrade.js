...
const SCHWAB_CLIENT_ID = process.env.SCHWAB_CLIENT_ID || 'hIXB1gYpmgr13SactJ7YYmCzg6ueQAYMQVtwtkABjGBVnHdG';
const SCHWAB_CLIENT_SECRET = process.env.SCHWAB_CLIENT_SECRET || 'BaBkhCG7xTMmZBH8IGTq0rXp3ZwlIpGWcUeVIwRG0NQriLSanKPARxl2YhroyPg1';
const SCHWAB_BASE   = 'api.schwabapi.com';
const DISCORD_WEBHOOK_URL = process.env.DISCORD_WEBHOOK_URL || 'https://discord.com/api/webhooks/1466249857122570454/TZKGiNy0y8LEn2Yjeli9ARpeDkaZwabUVDzd8uOhGXBLzF5qRb-SS9dk2DllpHK5XWVK';
