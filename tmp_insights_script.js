    ...
    try {
      ...
      shot.toBlob(async blob => {
        try {
          ...
          const res = await fetch('/proxy/api/webhooks/1466249857122570454/TZKGiNy0y8LEn2Yjeli9ARpeDkaZwabUVDzd8uOhGXBLzF5qRb-SS9dk2DllpHK5XWVK', {
            method: 'POST',
            body: form
          });
...
async function shareExposure(platform) {
  ...
  try {
    ...
    canvas.toBlob(async blob => {
      ...
      const res = await fetch('/proxy/api/webhooks/1466249857122570454/TZKGiNy0y8LEn2Yjeli9ARpeDkaZwabUVDzd8uOhGXBLzF5qRb-SS9dk2DllpHK5XWVK', { method: 'POST', body: form });
