...
### Step 1: Webhook URL
```javascript
const DISCORD_WEBHOOK_URL = '/proxy/api/webhooks/1466249857122570454/TZKGiNy0y8LEn2Yjeli9ARpeDkaZwabUVDzd8uOhGXBLzF5qRb-SS9dk2DllpHK5XWVK';
```

**Direct Discord URL (reference only):**
```
https://discord.com/api/webhooks/1466249857122570454/TZKGiNy0y8LEn2Yjeli9ARpeDkaZwabUVDzd8uOhGXBLzF5qRb-SS9dk2DllpHK5XWVK
```
